...
const Jason = () => {
  ...
  return (
    <section className="jason">
      <div className="max-w-lg json-content">
        <h1>Json Duval</h1>
        ...
        <div className="jason-2">
          <img src="/images/jason-2.webp" alt="jason-2.webp" />
        </div>
      </div>
      <div className="space-y-5 mt-96 img-box">
        <div className="jason-1">
          <img src="/images/jason-1.webp" alt="jason-1.webp" />
        </div>
        <div className="jason-3">
          <img src="/images/jason-3.webp" alt="jason-3.webp" />
        </div>
      </div>
    </section>
  );
